    ...
    def test_service_health(self):
        ...
        try:
            ...
            if response.status_code == 200:
                self.log_test("后端健康检查", True, "后端服务正常运行")
            else:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "access" in data:
                    ...
                    self.log_test("用户登录", True, f"成功登录用户: {TEST_USER['email']}")
                else:
    ...
    def test_payment_functionality(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("支付意图创建", False, f"创建失败，状态码: {response.status_code}")
        except Exception as e:
            self.log_test("支付意图创建", False, f"创建异常: {str(e)}")
    
    def run_all_tests(self):
        """运行所有测试"""
        print("🚀 开始 CareerBridge 全面功能测试")
        print("=" * 50)
