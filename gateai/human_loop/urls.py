...
app_name = 'human_loop'  # Backward compatibility: old name 'mentors' still works via URL redirect
...
urlpatterns = [
    ...
    # Human Review Tasks
    path('review-tasks/', views.HumanReviewTaskListView.as_view(), name='review-task-list'),
    path('review-tasks/<int:pk>/', views.HumanReviewTaskDetailView.as_view(), name='review-task-detail'),
]