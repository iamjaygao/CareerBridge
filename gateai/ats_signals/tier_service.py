...
class FreeTierService:
    ...
    def analyze_resume_with_keywords(self, resume_id, keywords, job_title=None, industry=None):
        ...
        # Perform basic analysis via OS Engine (legacy compatibility)
        analysis = analyze_resume_legacy(resume.id)
        # Convert analysis to dict format expected by this method
        analysis_result = {
            'overall_score': float(analysis.overall_score),
            'technical_skills': list(analysis.technical_skills or []),
            'soft_skills': list(analysis.soft_skills or []),
        }
