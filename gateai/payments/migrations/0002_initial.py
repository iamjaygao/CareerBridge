...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['provider', 'status'], name='payments_pa_provide_83393d_idx'),
        ),
        migrations.AddIndex(
            model_name='paymentwebhook',
            index=models.Index(fields=['event_type', 'status'], name='payments_pa_event_t_c6a447_idx'),
        ),
        migrations.AddField(
            model_name='refund',
            name='payment',
