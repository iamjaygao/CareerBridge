...
class NotificationType(str, Enum):
    ...
    STAFF_CRITICAL_SIGNAL_REVIEW = "STAFF_CRITICAL_SIGNAL_REVIEW"
    MENTOR_REVIEW_TASK_ASSIGNED = "MENTOR_REVIEW_TASK_ASSIGNED"
...
NOTIFICATION_TYPE_MAP: Dict[NotificationType, str] = {
    ...
    NotificationType.STAFF_CRITICAL_SIGNAL_REVIEW: "staff_critical_signal_review",
    NotificationType.MENTOR_REVIEW_TASK_ASSIGNED: "mentor_review_task_assigned",
}
...
NOTIFICATION_RULES: Dict[NotificationType, NotificationRule] = {
    ...
    NotificationType.STAFF_CRITICAL_SIGNAL_REVIEW: NotificationRule(
        type=NotificationType.STAFF_CRITICAL_SIGNAL_REVIEW,
        category=NotificationCategory.ACTION_REQUIRED,
        recipients=[Role.STAFF, Role.ADMIN],
        dedupe_key="signal_id",
        description="Critical ATS signal requires human review.",
    ),
    NotificationType.MENTOR_REVIEW_TASK_ASSIGNED: NotificationRule(
        type=NotificationType.MENTOR_REVIEW_TASK_ASSIGNED,
        category=NotificationCategory.ACTION_REQUIRED,
        recipients=[Role.MENTOR],
        dedupe_key="review_task_id",
        description="A review task has been assigned to you.",
    ),
}
