...
class TimeSlot(models.Model):
    ...
    mentor = models.ForeignKey('mentors.MentorProfile', on_delete=models.CASCADE, related_name='time_slots')
...
class AppointmentRequest(models.Model):
    ...
    mentor = models.ForeignKey('mentors.MentorProfile', on_delete=models.CASCADE, related_name='appointment_requests')
