...
const KernelWorldSidebar: React.FC<KernelWorldSidebarProps> = ({ mobileOpen, onMobileClose }) => {
  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        { text: 'Dashboard',                icon: <Dashboard />,         path: '/superadmin/command-center' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Peer Mock Runtime',        icon: <PlayCircleOutline />, path: '/superadmin/peer-mock-runtime', disabled: true },
      ],
    },
    {
      title: 'System',
