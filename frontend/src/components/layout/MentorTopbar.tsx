...
const MentorTopbar: React.FC<MentorTopbarProps> = ({ onMenuClick }) => {
    ...
    >
      <Toolbar sx={{ minHeight: '64px !important', px: { xs: 2, md: 3 } }}>
        ...
        >
          ...
          <InputBase
            placeholder="Search appointments, students..."
            value={searchQuery}
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          >
            <MenuItem onClick={() => { navigate('/mentor/profile'); handleProfileMenuClose(); }}>
